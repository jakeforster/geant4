...
//
//
/// \file A1/src/SteppingAction.cc
/// \brief Implementation of the A1::SteppingAction class
...
void SteppingAction::UserSteppingAction(const G4Step* step)
{
  ...
  //
  // assert(step->GetTrack()->GetKineticEnergy() == step->GetPostStepPoint()->GetKineticEnergy());
